      ...
      <div class="container tabs js-tabs">
        <div class="row txtcenter rubrique">
         ...
         <div class="row txtcenter ">
            <p class="h6-like contenu" >Le programme s'organise en deux semestres comprenant des modules obligatoires. </p> 
        ...
        <div class="alert--warning center moitie"> 
        ...
        <div class="alert--success center moitie">
